...
//        check if whipped cream is selected
        CheckBox whippedCream = (CheckBox) findViewById(R.id.t_pepperoni);
        boolean hasWhippedCream = whippedCream.isChecked();
        //        check if chocolate is selected
        CheckBox chocolate = (CheckBox) findViewById(R.id.t_tomoto);
...
// Write the relevant code for making the buttons work(i.e impelement the implicit and explicit intents
    ...
    /** Pizza Ordering
     * When clicks on this button
     * it should display the email layout and display the send button
     * when clicks on it, email should deliver to particular user.
     * **/
...
//        create and store the order summary
        ...
        i.putExtra("OrderDetails",orderSummaryMessage);
        startActivity(i);
    }
