...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    override fun onLocationChanged(location: Location?) {
        ...
        markerOptions.title("Current Position: Long:"+location.longitude+" Lati:"+location.latitude)

        //val imageBytes =Base64.decode(String,0);
        //val image = BitmapFactory.decodeStream()
        markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA))
        //markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.defaultMarker()))
